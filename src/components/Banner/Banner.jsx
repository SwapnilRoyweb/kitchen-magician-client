...
const Banner = () => {
    return (
        <div className='my-3 d-flex flex-column flex-lg-row align-items-center justify-content-evenly gap-2 bg-warning bg-opacity-75 rounded-pill border border-danger border-3 border-start-0 border-end-0 py-1 bg-banner'>
            <div className='ms-5 mt-4'>
                ...
                <div className='bg-warning px-5 py-2 ms-5 mt-4 text-center rounded-pill border border-5 border-danger border-end-0 border-top-0'>
