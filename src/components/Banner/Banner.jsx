...
const Banner = () => {
    return (
        <div className='my-3 d-flex flex-column flex-lg-row align-items-center justify-content-evenly gap-2 bg-warning bg-opacity-50 rounded-pill border border-danger border-3 border-start-0 border-end-0'>
