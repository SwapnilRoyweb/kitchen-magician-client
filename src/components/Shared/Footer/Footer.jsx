...
const Footer = () => {
    return (
        <div className='fixed-bottom mx-5'>
            {/* <div className='d-flex justify-content-center'>
                <img className='footer-image' src="https://i.ibb.co/DYQ0b5M/2870602-6411.jpg" alt="" />
            </div> */}
            <div className='d-flex flex-column flex-md-row gap-3 align-items-center justify-content-evenly bg-dark text-white p-3 rounded-top '>
